...
const LecturerViewCourseRegScreen = () => {
  ...
  const { semester, academicYear } = route.params as { semester: string; academicYear: any };
...
export default LecturerViewCourseRegScreen;
